...
const btnLoginMain = document.querySelector('.login-btn');
...
const openDemoModal = function () {
  demoModal.style.opacity = 100;
  // demoModal.style.display = 'block';
};

const closeDemoModal = function () {
